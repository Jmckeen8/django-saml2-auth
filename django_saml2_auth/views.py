...
def acs(r):
    ...
    username_match = re.match(r'([a-zA-Z0-9]*)@wpi.edu', user_identity[settings.SAML2_AUTH.get('ATTRIBUTES_MAP', {}).get('username', 'UserName')][0])
    if username_match is None:
        raise Exception('The username does not end in @wpi.edu')
